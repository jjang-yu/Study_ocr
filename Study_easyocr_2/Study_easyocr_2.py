...
def putText(cv_img, text, x, y, color=(0, 0, 0), font_size=22):
  ...
  font = ImageFont.truetype('/content/drive/MyDrive/Project/font/HYGothic-Extra Regular.ttf', font_size)
...
img_path = '/content/drive/MyDrive/Project/test/save_result.jpg'
